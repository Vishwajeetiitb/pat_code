...
optParser.add_option("--input_edg", dest="inFile_edg", default="complex_final.edg.xml", help="specifies the edge file to open")
optParser.add_option("--input_nod", dest="inFile_nod", default="complex_final.nod.xml", help="specifies the node file to open")
optParser.add_option("--output", dest="outFile", default="complex_final.graphml", help="specifies the name of the graphml file generated")
