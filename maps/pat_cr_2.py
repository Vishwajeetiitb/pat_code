...
class rl_env(object):
    ...
    def reset(self, route0, route1):
        ...
        traci.vehicle.add(vehID = 'veh1',routeID = 'rou_0', typeID = "car1")
        traci.vehicle.add(vehID = 'veh2',routeID = 'rou_1', typeID = "car1")
        return self.state
#end of class
...
def run(env):
    ...
    # rou_curr0= "12to"+str(random.choice([17,7,13,11]))
    # rou_curr1= "12to"+str(random.choice([17,7,13,11]))
    rou_curr0= "0to"+str(5)
    rou_curr1= "24to"+str(19)
    ...
    test_idl1=np.zeros((25,1))
    test_idl2=np.zeros((25,1))
    # print(global_idl)
    ...
    while traci.simulation.getMinExpectedNumber()>0:
        ...
        if sumo_step >5000:
            test_idl1 += idle[0]
            test_idl2 += idle[1]
        edge[0]=traci.vehicle.getRoadID('veh1')
        edge[1]=traci.vehicle.getRoadID('veh2')
        ...
        for i in range(2):
            if prev_node[i]!=curr_node[i]:
                ...
                # print('Veh angle: ', traci.vehicle.getAngle('veh'+str(i+1)))
                rou_step=[]
                ...
                traci.vehicle.setRoute(vehID = 'veh'+str(i+1), edgeList = rou_step)
                rou_curr[i]=rou_new
    ...
    test_idl1 = test_idl1/15000
    test_idl2 = test_idl2/15000
    # print(test_idl1,test_idl2)
    print(node)
    plt.subplot(2, 2, 1)
    ...
    k = []
    for i in range(25):
        k.append(np.mean(global_v_idl[i]))
    plt.plot(a,k, label='idle')
    plt.legend()
    # plt.subplot(2, 2, 4)
    # plt.plot(a,test_idl2, label='idle1')
    plt.legend()
